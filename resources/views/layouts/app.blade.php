    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="home">
        <div class="sidebar-brand-icon rotate-n-15">
          <i class="fa fa-lightbulb-o" style="color: white;"></i>
        </div>
        <div class="sidebar-brand-text mx-3">Unisoft <sup>1.0</sup></div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="regemp">Empresas</a>
            <a class="collapse-item" href="regco">Centro Operaciones</a>
            <a class="collapse-item" href="regcc">Centro Costos</a>
            <a class="collapse-item" href="regsed">Sedes</a>
            <a class="collapse-item" href="regterc">Terceros</a>
            <a class="collapse-item" href="regcaj">Cajas</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePages" aria-expanded="true" aria-controls="collapsePages">
          ...
          <span>Doc. Bodegas</span>
        </a>
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Movimiento:</h6>
            <a class="collapse-item" href="regdociai">Ingreso Ajuste Inventario</a>
            <a class="collapse-item" href="regdocicd">Ingreso Compra Directa</a>
            <a class="collapse-item" href="regdoceai">Egreso Ajuste Inventario</a>
            <a class="collapse-item" href="regdocepr">Egreso Por Remision</a>
            <a class="collapse-item" href="regdocepv">Egreso Por Venta</a>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; SINNET 2019</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->

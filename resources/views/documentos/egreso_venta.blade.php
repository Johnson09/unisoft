...
function validarProducto(){
    ...
    if (bod == '') {
        ...
        $.get('{{ action('DocumentoEgresoVentaController@getProducto') }}?id='+id+'&bod='+bod, function(data) {
...
function agregarInventario(){
    ...
    $.get('{{ action('DocumentoEgresoVentaController@searchDetail') }}?id='+nume+'&pro='+prod+'&lote='+lote, function(data) {
        
        if (data == "") {
            $.get('{{ action('DocumentoEgresoVentaController@saveDetail') }}?id='+nume+'&bod='+bode+'&pro='+prod+'&can='+cant+'&cos='+cost+'&lot='+lote+'&vto='+vto, function(data) {
            ...
            .then((willDelete) => {
                if (willDelete) {
                    return fetch(`{{ action('DocumentoEgresoVentaController@updateDetail') }}?id=`+registro+'&can='+cant+'&lot='+lote);
                }else {
...
function eliminarInventario(id_registro){
    ...
    $.get('{{ action('DocumentoEgresoVentaController@deleteDetail') }}?id='+id_registro, function(data) {});
...
function searchDoc(){
    ...
    $.get('{{ action('DocumentoEgresoVentaController@getDocumentosEgresoVenta') }}?doc='+doc+'&bod='+bod+'&ini='+ini+'&fin='+ini, function(data) {
...
function actualizarDoc(numero){
    ...
    $.get('{{ action('DocumentoEgresoVentaController@getData') }}?id='+numero, function(data) {
...
<div class="container-fluid">
    <h3 style="text-align: center;">EGRESO POR VENTA</h3>
                ...
                <tbody>
                    @foreach($documento as $doc)
                        <tr>
                            ...
                            <td>
                                <a href="{{action('DocumentoEgresoVentaController@destroy', $doc->numero)}}" class="btn btn-warning">
                                    Eliminar
                                </a>
                            </td>
                        </tr>
...
<div id="searchModal" class="modal fade" role="dialog">
    ...
    <div class="modal-content">
        <div class="modal-header">
            <h4 style="color: #000000; font-size: 1.5em;">DOCUMENTOS DE EGRESO POR VENTA</h4>
        </div>
...
<div id="generarModal" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="container-fluid text-center">
            <h2 style="color: #2c53c5;"><b>EGRESO POR VENTA</b></h2>
        </div>
        <hr>

...
function validarProducto(){
    ...
    if (bod == '') {
        ...
        $.get('{{ action('DocumentoInventarioController@getProducto') }}?id='+id+'&bod='+bod, function(data) {
...
function agregarInventario(){
    ...
    $.get('{{ action('DocumentoInventarioController@searchDetail') }}?id='+nume+'&pro='+prod+'&lote='+lote, function(data) {
        
        if (data == "") {
            $.get('{{ action('DocumentoInventarioController@saveDetail') }}?id='+nume+'&bod='+bode+'&pro='+prod+'&can='+cant+'&cos='+cost+'&lot='+lote+'&vto='+vto, function(data) {
            ...
            .then((willDelete) => {
                if (willDelete) {
                    return fetch(`{{ action('DocumentoInventarioController@updateDetail') }}?id=`+registro+'&can='+cant+'&lot='+lote);
                }else {
...
function eliminarInventario(id_registro){
    ...
    $.get('{{ action('DocumentoInventarioController@deleteDetail') }}?id='+id_registro, function(data) {});
...
function searchDoc(){
    ...
    $.get('{{ action('DocumentoInventarioController@getDocumentosInventario') }}?doc='+doc+'&bod='+bod+'&ini='+ini+'&fin='+ini, function(data) {
...
function actualizarDoc(numero){
    ...
    $.get('{{ action('DocumentoInventarioController@getData') }}?id='+numero, function(data) {
...
<div class="container-fluid">
    <h3 style="text-align: center;">INGRESO AJUSTE INVENTARIO</h3>
                ...
                <tbody>
                    @foreach($documento as $doc)
                        <tr>
                            ...
                            <td>
                                <a href="{{action('DocumentoInventarioController@destroy', $doc->numero)}}" class="btn btn-warning">
                                    Eliminar
                                </a>
                            </td>
                        </tr>
...
<div id="searchModal" class="modal fade" role="dialog">
    ...
    <div class="modal-content">
        <div class="modal-header">
            <h4 style="color: #000000; font-size: 1.5em;">INGRESOS POR AJUSTE DE INVENTARIO</h4>
        </div>
...
<div id="generarModal" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="container-fluid text-center">
            <h2 style="color: #2c53c5; text-align: center;"><b>INGRESO POR AJUSTE FISICO DE INVENTARIO</b></h2>
        </div>
        <hr>

        <div class="modal-body" style="font-size: 14px">
            <div style="text-align: center;">
                <form role="form" action="{{ url('regdociai') }}" method="post" id="form">
                @csrf
                <hr>
